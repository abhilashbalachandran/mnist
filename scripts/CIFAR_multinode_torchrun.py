...
class Trainer:
    ...
    def _run_epoch(self,epoch):
        ...
        epoch_loss_tensor = torch.tensor(epoch_loss).to(self.local_rank)
        total_samples_tensor = torch.tensor(total_samples).to(self.local_rank)
        ...
        if self.local_rank == 0:  # Typically, we let the master process do the printing
